...
```
/mammals/categories/fluffy?page=1&limit=50&sort=id&order=asc
/mammals/categories/fluffy?page=2&limit=50&sort=id&order=asc
```
...
Example Output:
```
<p>2017-05-17T04:00:10.1960000+00:00</p>
<p>2017-05-17T04:07:20.5230000+00:00</p>
```
...
Example Output:
```
<p>2017-05-31 05:18:52Z</p>
<p>2017-05-31 02:47:40Z</p>
```
...
Example Output:
```
<p>/mammals/view/hedgehog</p>
<p>/mammals/view/chinchilla</p>
```

### Items `fields`
The content endered in the Admin panel for each item is accessible through the item's `fields` property.
