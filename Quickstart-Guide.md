...
Not quite ready to create a project yet? Take a look at some of our [Featured Projects](https://airshipcms.io/featured-projects) &amp; [Open Source Demos & Boilerplates](https://airshipcms.io/documentation/view/boilerplates-examples).
...
1. Navigate to your project url `(https://mysite.airshipcms.io)`, and check that your temporary landig page is ready. It will look something like this:  
